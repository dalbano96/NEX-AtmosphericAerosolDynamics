...
tempdf <- subset(hourly.pm25.FRM.14_17, County.Name == "San Bernardino" & Site.Num == 306)

tempdf %>%
  subset(DateTime.Local >= "2016-05-01" & DateTime.Local <= "2016-12-31") %>%
  ggplot() +
  geom_point(aes(x = POC, y = Sample.Measurement, color = as.character(POC)))
